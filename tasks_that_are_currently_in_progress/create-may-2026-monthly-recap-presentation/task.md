...
## Goals
- Calculate exact/estimated savings for migrating away from Recall AI & AWS to Splain + self-hosted systems.
...
2. [x] Calculate the cost savings if we switch to the Splain plan + self-hosted n8n/Autobot.
   - Evidence: Estimated monthly savings of ~$293 to ~$307/mo ($3.5K to $3.6K/yr) by replacing Recall AI ($367) + Railway ($10) with Splain ($70 - $84 for 10-12 Zoom users) and hosting on the existing Hetzner VPS ($0 incremental).
